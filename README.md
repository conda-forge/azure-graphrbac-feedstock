...
<table><tr>
    ...
    <td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6251&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/azure-graphrbac-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `azure-graphrbac` can be installed with:

```
conda install azure-graphrbac
```

It is possible to list all of the versions of `azure-graphrbac` available on your platform with:
